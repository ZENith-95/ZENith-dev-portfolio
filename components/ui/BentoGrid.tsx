...
export const BentoGridItem = ({
  ...
  const rightLists = ["Motoko", "NextJS", "JavaScript"];
  ...
  return (
    <div
      ...
      style={{
        ...
        background: "rgba(1, 7, 66, 0.14)",
        backgroundColor:
          "linear-gradient(90deg, rgba(97, 6, 201, 0.21) 0%,rgba(18, 32, 226, 0.25)) 100%)",
      }}>
      {/* add img divs */}
        ...
        <div
          ...
          {id === 3 && (
            <div className="flex gap-1 lg:gap-3 w-fit absolute -right-3 lg:-right-2">
              ...
              <div className="flex flex-col gap-3 md:gap-2 lg:gap-2 lg:pb-4">
                <span className="lg:py-4 lg:px-3 py-4 px-3  rounded-lg text-center bg-[#10132E]"></span>
          ...
          {id === 6 && (
            <div className="mt-5 relative">
              ...
              <MagicButton
                ...
                otherClasses="!bg-[rgba(0, 14, 73, 0.15)]"
              />
            </div>
          )}
        </div>
